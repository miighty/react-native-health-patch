...
RCT_EXPORT_METHOD(getAppleWristTemperature:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self _initializeHealthStore];
    [self body_AppleSleepingWristTemperature:input callback:callback];
}
